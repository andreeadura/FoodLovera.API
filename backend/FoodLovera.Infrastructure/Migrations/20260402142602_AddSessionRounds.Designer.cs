...
namespace FoodLovera.Infrastructure.Migrations
{
    ...
    [Migration("20260402142602_AddSessionRounds")]
    partial class AddSessionRounds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodLovera.Models.Entities.EmailVerificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FoodLovera.Models.Entities.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FoodLovera.Models.Entities.SessionRound", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FoodLovera.Models.Entities.SessionRoundVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SessionRoundId", "ParticipantId")
                        .IsUnique();

                    b.ToTable("SessionRoundVotes");
                });
            ...
            modelBuilder.Entity("FoodLovera.Models.Entities.EmailVerificationToken", b =>
                {
                    b.HasOne("FoodLovera.Models.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodLovera.Models.Entities.SessionRoundVote", b =>
                {
                    b.HasOne("FoodLovera.Models.Entities.SessionParticipant", "Participant")
                        .WithMany()
                        .HasForeignKey("ParticipantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FoodLovera.Models.Entities.SessionRound", "SessionRound")
                        .WithMany("Votes")
